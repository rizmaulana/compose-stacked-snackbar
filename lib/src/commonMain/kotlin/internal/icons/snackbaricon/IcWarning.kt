...
public val SnackbarIcon.IcWarning: ImageVector
    get() {
        ...
        _icWarning = Builder(name = "IcWarning", defaultWidth = 800.0.dp, defaultHeight = 800.0.dp,
                viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(SnackbarColor.Warning), stroke = SolidColor(SnackbarColor.Warning),
