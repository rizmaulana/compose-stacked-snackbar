...
public val SnackbarIcon.IcError: ImageVector
    get() {
        ...
        _icError = Builder(name = "IcError", defaultWidth = 800.0.dp, defaultHeight = 800.0.dp,
                viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(SnackbarColor.Error), stroke = SolidColor(SnackbarColor.Error),
